...
import {
  LoginDataHandler,
  LoginPageTokenVerifier,
} from "../../Modules/LoginPage.module";
...
function Login() {
  ...
  // const handleTokenVerifier = async () => {
  //   const response = await LoginPageTokenVerifier();
      ...
      <div className="w-screen flex bg-[#F2F0F1] justify-center h-screen items-center">
        <main className="w-full sm:w-2/3 lg:w-3/12 p-4 bg-white rounded-lg shadow-md border h-fit">
          ...
          <form
            action=""
            onSubmit={(e) => {
              handleFormData(email.current.value, password.current.value);
              e.preventDefault();
            }}
          >
            <div>
